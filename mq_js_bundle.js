"use strict";
const version = "0.3.12", canvas = document.querySelector("#glcanvas"), gl = canvas.getContext("webgl");
gl === null && alert("Unable to initialize WebGL. Your browser or machine may not support it.");
var clipboard = null, wasm_memory, FS, GL, Module, wasm_exports, emscripten_shaders_hack, importObject, ctx, js_objects,
    unique_js_id, quad_socket, connected, received_buffer, uid, ongoing_requests, plugins = [], high_dpi = !1;
...
` + i)), gl.shaderSource(GL.shaders[e], o)
            ...
            document.addEventListener("visibilitychange", t), window.addEventListener("focus", t), window.addEventListener("blur", t), window.requestAnimationFrame(animation)
...
function u32_to_semver(e) {
    let t = e >> 24 & 255, n = e >> 16 & 255, s = e & 65535;
    return t + "." + n + "." + s
}
...
function audio_init() {
    if (audio_context == null) {
        ...
        {
            let n = window.AudioContext || window.webkitAudioContext, t = new n;
            var e = function () {
                console.log("fix"), audio_context.resume();
                var o = t.createBuffer(1, 1, 22050), s = t.createBufferSource();
...
function audio_add_buffer(e, t) {
    let s = wasm_memory.buffer.slice(e, e + t), n = sound_key_next;
...
function audio_play_buffer(e, t, n) {
    let o = playback_key_next++, s = recycle_playback();
...
ctx = null, js_objects = {}, js_objects[-1] = null, js_objects[-2] = void 0, unique_js_id = 0, register_plugin = function (e) {
    e.env.js_create_string = function (e, t) {
        ...
        var n = new Uint8Array(wasm_memory.buffer, e, t), s = new Uint8Array(new ArrayBuffer(n.byteLength));
        ...
        var i = UTF8ToString(t, n), a = UTF8ToString(s, o);
        js_objects[e][i] = a
        ...
        var s = UTF8ToString(t, n), o = js_objects[e][s];
        return js_object(o)
...
function ws_connect(e) {
    quad_socket = new WebSocket(consume_js_object(e)), quad_socket.binaryType = "arraybuffer", quad_socket.onopen = function () {
        ...
        if (typeof e.data == "string") received_buffer.push({text: 1, data: e.data}); else {
